...
虽然有几种 actors ，但这些 actors 共享一个统一的接口来相互沟通。  为它们通信提供了各种方法，但总是使用Request（）来确认 发送方actor 所在的 接收方actor 。  如果这不是一个选项，  请在发送消息中包含发送方actor的[actor.PID](https://github.com/AsynkronIT/protoactor-go/blob/3992780c0af683deb5ec3746f4ec5845139c6e42/actor/pid.go#L12-L17)  。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2MDAxNDMwNDQsODcwMzI5MTgyLDEwMz
