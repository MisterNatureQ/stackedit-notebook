...
func main() {  
  ...
  roots := os.Args[1:]  
   ...
   //!+2  
 // Cancel traversal when input is detected. // 中断 goroutine  go func() {  
...
loop:  
  ...
  select {  
      case <-done:  
         // 监控 用户中断  
 // Drain fileSizes to allow existing goroutines to finish. // 等待 fileSizes 的close  for range fileSizes {  
            // Do nothing.  
  }  
         return  
...
func dirents(dir string) []os.FileInfo {  
 ...
 // 监控中断 当channel 被close 之后 这里就可以进入了  case <-done:  
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0MTA5ODE4NDksNTQ0MDU5Mjk0LDc1Mj
c4NzEyMywxNDgzNjU2NjMzLC0xNzM4NjYzODY4LC0xMDc1Mjg2
Mzk2LC0xNjUxNTU4NDU2LC0xNTI3MDM0MDIwLDE2ODc0MzY2OT
IsLTgyNTQ5OTU1NCwxMzA3MDczMTE4LC01Mjk5NjM0MTUsLTM4
MTIwNTk2MV19
-->