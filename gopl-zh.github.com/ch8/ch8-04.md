...
以最简单方式调用make函数创建的是一个无缓存的channel，但是我们也可以指定第二个整型参数，对应channel的容量。如果channel的容量大于零，那么该channel就是**带缓存的channel**。
...
{% include "./ch8-04-4.md" %}
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQyMDE3MDY0LC01ODgyMjI0MjQsMTQ2Nj
IxMTA4MV19
-->