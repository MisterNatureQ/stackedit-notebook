...
func makeThumbnails6(filenames <-chan string) int64 {
	...
	// closer
	// 单独的 goroutine 等待 别的 goroutine 结束
	go func() {
		wg.Wait()
		// 主要是为了 close 的通信作用??
		close(sizes)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1ODE0MTE3NzgsLTkyNjk4ODU4NCwxND
EyMzE0NTc4LDU3OTcxNDk2MiwtMjA3OTY1MjcyMSwtMTA1NjYw
NzM3OSwtNTA1NTE3NTAzLC0zMTUwOTU1MDQsMTI4OTM5NzgwOF
19
-->