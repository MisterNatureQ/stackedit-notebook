...
```go
// 当在windows 输入 crtl+Z 发送一个EOF 的时候会报错
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTkzNzYzNTEwNiwxMjQwMTUxMSwtMTY1NT
ExMTMyMSwyMDA2MTU1NzQ3LDIwMTAyMDM0ODEsLTM0NDQ1MDAz
MywtMTUwNjMzNjU5LDE4OTY3NTQwNl19
-->