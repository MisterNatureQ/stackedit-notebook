...
func main() {
	...
	seen := make(map[string]bool)
	// main goroutine 从1 worklist channel 中读取数据
	for list := range worklist {
		for _, link := range list {
			if !seen[link] {
				seen[link] = true
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTc4NjQ5MzM3MCwtMzI3NzIyMzY0LDc0MD
g2NDAwMSw2Mzk5OTY3NDYsLTE1MzEwMzc2NTgsMTk3ODc0NzQx
LC0xMDI0NzAxMzY0LDY0Mzc0MzY5Miw2NzAxNDg2ODYsMTI4NT
U2Mzc3MywxODQ3MTkxNTQ5LDExNjUwNTM1NDIsMTUwMDA4MTMz
MSwxODcxOTEwMDY3LDkzNDEzNDMyMyw5NjgzMjI3MTQsLTIwMD
Q2MDY0ODQsLTE1NTM2NDIwMDQsLTg5MTU5MDQzLC0xODQzNDAw
MzMxXX0=
-->