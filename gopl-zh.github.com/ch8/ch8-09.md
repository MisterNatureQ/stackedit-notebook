...
回忆一下我们关闭了一个channel并且被消费掉了所有已发送的值，操作channel之后的代码可以立即被执行，并且会产生零值。我们可以将这个机制扩展一下，来作为我们的**广播机制：不要向channel发送值，而是用关闭一个channel来进行广播**。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTI4NTE3MzM1NSwxNjQ5OTY2OTU1LDE3MT
Q4NjgyNzEsLTQ3MTU3MDE5MywtMTY0NzkwNzQ3MywtMTk2MTM1
NDcwNV19
-->