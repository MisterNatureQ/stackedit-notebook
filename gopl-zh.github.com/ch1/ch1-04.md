...
![](../images/ch1-01.png)
![](https://github.com/gopl-zh/gopl-zh.github.com/blob/master/images/ch1-01.png?raw=true)
译注：要看这个程序的结果，需要将标准输出重定向到一个GIF图像文件（使用 `./lissajous > output.gif` 命令）。下面是GIF图像动画效果：

![](../images/ch1-01.gif)
![](https://github.com/gopl-zh/gopl-zh.github.com/blob/master/images/ch1-01.gif?raw=true)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDAxMjk0Mjc4XX0=
-->