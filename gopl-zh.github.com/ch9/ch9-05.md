...
func Icon(name string) image.Image {
	...
	// 提升读的效率 但是在遇到不存在的访问项的时候 还是有浪费
	// 但是有一点太复杂且容易出错 ??
	// acquire an exclusive lock
	// 读写锁
	mu.Lock()
	// 获取锁之后 还是有必要重新检测 icons 是否为nil  所以我们必须重新检查icons变量是否为nil，以防止在执行这一段代码的时候，icons变量已经被其它gorouine初始化过了
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4ODgzNTIyOTcsNjEwMjAyNTgzLC0xNj
AyMDgyOTUsLTIwMDgyMDM5NjIsLTM3OTg1NDE4OCw4MzgxNjY1
MjQsLTE4MzkwMjk1NDQsLTExOTg2MjA3MDYsLTM3NTM4NzYyNi
wyNzYzOTM4MiwtMTMwOTIwMTE5NCwxMDM4NDM3OTEwLDIwMDUw
MDA2NDEsOTczNjEzMzc3XX0=
-->