...
// 但是潜在的问题在于 获取数据的函数调用没有加锁 在并行中可能被同时调用 拖累xiaol
func (memo *Memo) Get(key string) (value interface{}, err error) {
	// 查找阶段获取一次锁
	memo.mu.Lock()
	res, ok := memo.cache[key]
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbODYwNjM0NjY0LC0xMTQ5NjEzNTUwLC03MD
EyNTIzOTgsLTIwMjc5NDkyNDgsMTQ2NzE5NTgzNCwxODIyMzQ5
OTQ2LC0xMDIzNzQ5MzQ1LDQ1NTUwNDIxNiwxMDk2NTM0MDU1LD
EyNjE4NTU5NTksODI1Njg3MTE0LDE4NjY3OTUyMjksMTU4MzI2
NTM1OCwxNTg3MzY5NDI3LDEzNzIyMTA5NTUsLTExODY5MjMxNz
gsLTE2MzUzODQ5Ml19
-->