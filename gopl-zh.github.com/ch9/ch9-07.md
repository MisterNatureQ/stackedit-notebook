...
// 这里即使用RWMutex 也不能解决 需要 重复抑制/避免 的went
func (memo *Memo) Get(key string) (value interface{}, err error) {
	// 查找阶段获取一次锁
	memo.mu.Lock()
	res, ok := memo.cache[key]
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTAyMTg0MTQ2NiwxNTEyMjIyNTMsMTMxNz
Q4MTU5NCw4MzAxNjMxOTQsOTI2MDcxMzAwLDIwNTE5MjkzNDgs
LTIwODM0MTU1NzUsMTMwMjQ1MjE3MiwtNjYzNTcxNzg4LDExNT
g1MTQzMTgsMzI2ODk4Nzg4LDE4OTY2OTAzNDksNjc5NDcxNzg5
LC02MzgxNjkxNDAsMjA0NjA5MzA3OCwtNzYxNjU1OTU2LC0xMT
Q5NjEzNTUwLC03MDEyNTIzOTgsLTIwMjc5NDkyNDgsMTQ2NzE5
NTgzNF19
-->